...
func (s *SettingService) GetPublicSettings(ctx context.Context) (*PublicSettings, error) {
	keys := []string{
		...
		SettingPaymentBalanceDisplayCurrency,
	...
	return &PublicSettings{
		...
		PaymentBalanceDisplayCurrency:       normalizeStoredPaymentBalanceDisplayCurrency(settings[SettingPaymentBalanceDisplayCurrency]),
...
func (s *SettingService) GetPublicSettingsForInjection(ctx context.Context) (any, error) {
	...
	return &PublicSettingsInjectionPayload{
		...
		PaymentBalanceDisplayCurrency:       settings.PaymentBalanceDisplayCurrency,
		Version:                             s.version,
