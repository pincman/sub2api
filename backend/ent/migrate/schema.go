...
var (
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "upgrade_source_subscription_id", Type: field.TypeInt64, Nullable: true},
		{Name: "upgrade_snapshot", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
	...
	PaymentOrdersTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "paymentorder_upgrade_source_subscription_id",
				Unique:  false,
