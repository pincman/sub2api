        ...
        >
          ...
          <div class="p-4">
            ...
            <template v-else>
              ...
              <!-- Priority 2: Custom update has been safely queued -->
              <div v-else-if="updateSuccess && !needRestart" class="space-y-2">
                ...
                >
                  ...
                  >
                    <Icon name="clock" size="sm" :stroke-width="2" class="text-green-600 dark:text-green-400" />
                  </div>
                  <div class="min-w-0 flex-1">
                    ...
                    <p class="text-xs text-green-600/70 dark:text-green-400/70">
                      {{ t('version.customUpdateStartedHint') }}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div v-else-if="hasUpdate && !canInstallUpdates" class="space-y-2">
                <a
              ...
              <!-- Priority 4: Update available for managed release/custom build -->
              <div v-else-if="hasUpdate && canInstallUpdates" class="space-y-2">
                <!-- Update info card -->
                <div
              ...
              <div v-else class="space-y-2">
                ...
                <div v-if="isReleaseBuild" class="border-t border-gray-100 pt-2 dark:border-dark-700">
                  <button
...
// Release builds update from upstream. Custom builds update only from the
// verified release stream generated by this fork's CI workflow.
const isReleaseBuild = computed(() => buildType.value === 'release')
const isCustomBuild = computed(() => buildType.value === 'custom')
const canInstallUpdates = computed(() => isReleaseBuild.value || isCustomBuild.value)
