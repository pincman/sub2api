...
describe('admin order currency display', () => {
  it('uses order currency for paid/base/fee amounts and yuan for credited/refund amounts', () => {
  ...
  it('uses order currency for pay_amount and yuan for refundable balance amounts', () => {
