export default {
  ...
  version: {
    ...
    customModeHint: 'This custom build installs only tested releases from pincman/sub2api and never downloads an official binary.',
    updateNow: 'Update Now',
    updating: 'Updating...',
    updateComplete: 'Update Complete',
    customUpdateStarted: 'Custom Update Started',
    customUpdateStartedHint: 'A full backup, custom release verification, deployment, and health checks are running. The service will recover automatically when finished.',
  ...
  payment: {
    ...
    upgradeDifference: 'upgrade difference',
    sourcePlanValue: 'Current plan price',
    remainingQuotaCredit: 'Unused quota credit',
    targetPlanPrice: 'Target plan price',
    upgradeResetHint: 'After payment, the plan starts with a fresh ${quota} monthly quota for {days} days. Existing API keys are moved automatically.',
    upgradeLockHint: 'After the upgrade order is created, the current plan is paused to lock the credit amount. It switches on payment and is restored automatically after cancellation, failure, or timeout.',
    upgradePay: 'Upgrade payment',
    creditApplied: '{amount} credit applied',
    ...
    errors: {
      ...
      UPGRADE_SOURCE_PLAN_NOT_FOUND: 'The current subscription is not linked to a purchasable plan.',
      UPGRADE_SOURCE_UNAVAILABLE: 'The source subscription is unavailable or already has an upgrade in progress.',
      UPGRADE_TARGET_ALREADY_OWNED: 'You already own the target subscription.',
      UPGRADE_QUOTE_CHANGED: 'Subscription usage changed. Reopen the upgrade dialog to confirm the new amount.',
      UPGRADE_ALREADY_PENDING: 'This subscription already has a pending upgrade order.',
      UPGRADE_TARGET_INCOMPATIBLE: 'The target plan is not compatible with the current plan.',
      UPGRADE_TARGET_NOT_HIGHER: 'You can only upgrade to a higher-priced plan with more quota.',
