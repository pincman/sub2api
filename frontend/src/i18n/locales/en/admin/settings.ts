export default {
    settings: {
      ...
      payment: {
        ...
        balancePaymentDisabledHint: 'Hides Recharge and rejects new balance recharge orders when enabled.',
        subscriptionPaymentDisabled: 'Disable Subscription Purchases',
        subscriptionPaymentDisabledHint: 'Hides Subscriptions and plan cards, and rejects new subscription orders when enabled.',
        rechargeDescription: 'Recharge Description (Markdown)',
        rechargeDescriptionHint: 'Shown below the current balance for every user. Leave empty to hide it. Markdown is supported.',
        rechargeDescriptionPlaceholder: '- Claude: ¥1 = $1\n- Grok: ¥2 = $1',
