export default {
  ...
  version: {
    ...
    customModeHint: '这是二开版本。更新只会安装 pincman/sub2api 自动测试并发布的自定义版本，绝不会下载官方二进制。',
    updateNow: '立即更新',
    updating: '正在更新...',
    updateComplete: '更新完成',
    customUpdateStarted: '自定义更新已开始',
    customUpdateStartedHint: '正在自动备份、校验自定义 Release、部署并检查健康状态；完成后服务会自行恢复。',
    updateFailed: '更新失败',
  ...
  payment: {
    ...
    upgradeDifference: '升级补差',
    sourcePlanValue: '原套餐价格',
    remainingQuotaCredit: '剩余额度抵扣',
    targetPlanPrice: '新套餐价格',
    upgradeResetHint: '支付成功后获得全新 ${quota} 月额度，有效期重置为 {days} 天；旧套餐与 API Key 会自动迁移。',
    upgradeLockHint: '创建升级订单后，原套餐会暂时停用以锁定抵扣金额；支付成功后自动切换，取消、失败或超时会自动恢复。',
    upgradePay: '需补差价',
    creditApplied: '已抵扣 {amount}',
    ...
    errors: {
      ...
      UPGRADE_SOURCE_PLAN_NOT_FOUND: '当前订阅没有可识别的购买套餐，无法自动升级',
      UPGRADE_SOURCE_UNAVAILABLE: '原套餐不可用，或已有升级订单正在处理中',
      UPGRADE_TARGET_ALREADY_OWNED: '你已经拥有目标套餐',
      UPGRADE_QUOTE_CHANGED: '套餐用量刚刚发生变化，请重新打开升级页面确认差价',
      UPGRADE_ALREADY_PENDING: '该套餐已有待支付的升级订单',
      UPGRADE_TARGET_INCOMPATIBLE: '目标套餐与当前套餐不兼容',
      UPGRADE_TARGET_NOT_HIGHER: '只能升级到价格和额度更高的套餐',
