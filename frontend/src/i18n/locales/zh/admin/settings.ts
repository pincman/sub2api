export default {
    settings: {
      ...
      payment: {
        ...
        balancePaymentDisabledHint: '开启后前台隐藏“充值”页，并拒绝新的余额充值订单。',
        subscriptionPaymentDisabled: '禁用订阅购买',
        subscriptionPaymentDisabledHint: '开启后前台隐藏“订阅”页和套餐卡片，并拒绝新的订阅订单。',
        rechargeDescription: '充值说明（Markdown）',
        rechargeDescriptionHint: '显示在充值账户卡片的当前余额下方；留空则不显示。支持 Markdown，保存后对所有用户可见。',
        rechargeDescriptionPlaceholder: '- Claude 价格为 ¥1 = $1\n- Grok 价格为 ¥2 = $1',
        noLimit: '留空表示不限制',
        helpImage: '帮助图片',
